...
public class Manager extends User implements Serializable {
    ...
    public Manager(String id, String password, String lastname, String middlename,
            String firstname, String email, String phoneNumber, LocalDate DOB,
            String address, ImageIcon photo, boolean isMale) {
        super(id, password, lastname, middlename, firstname, email, phoneNumber,
                DOB, address, photo, isMale);
    }
